...
2. e_com.gold.customer_360
   - Columns: customer_id (string), customer_name (string), state (string), city (string), registration_date (date), last_purchase_date (date), total_revenue (double), total_orders (int), total_loyalty_points (int), avg_satisfaction_score (double), customer_tenure_days (int), age (int), gender (string), customer_profile (string like VIP/Premium/Regular), churn_flag (int/bool), avg_order_value (double), total_profit (double)
